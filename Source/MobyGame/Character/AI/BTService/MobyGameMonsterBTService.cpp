...
#include "MobyGameMonsterBTService.h"
...
void UMobyGameMonsterBTService::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
void UMobyGameMonsterBTService::InitializeFromAsset(UBehaviorTree& Asset)
{
